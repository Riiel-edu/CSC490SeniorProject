...
fun LandingScreen(viewModel: LandingScreenVM, modifier: Modifier) {
    ...
    Column(modifier = Modifier.fillMaxSize().background(Color(0xFFfefaff))) {
        ...
        Surface(modifier = Modifier.fillMaxWidth().padding(20.dp), shape = RoundedCornerShape(10.dp), shadowElevation = 30.dp, color = Color(0xFFbfb1fa)) {
            Column(modifier = Modifier.padding(10.dp)) {
                Text("Dive right back into the music!", fontFamily = fredoka, fontSize = 20.sp, color = Color.White)

                Spacer(modifier = Modifier.height(2.5.dp))

                HorizontalDivider(color = Color.White, modifier = Modifier.fillMaxWidth(), thickness = 2.dp)
        ...
        Surface(color = Color(0xFFbfb1fa), modifier = Modifier.fillMaxWidth().padding(20.dp), shape = RoundedCornerShape(10.dp), shadowElevation = 30.dp) {
            Column(modifier = Modifier.padding(10.dp)) {
                Text("Today's Top 10", fontFamily = fredoka, fontSize = 26.sp, color = Color.White)
                ...
                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                    ...
                    Column(modifier = Modifier.padding(10.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        ...
                        Surface(shadowElevation = 30.dp, modifier = Modifier.fillMaxWidth().padding(5.dp)) {
        ...
        Surface(color = Color(0xFFbfb1fa), modifier = Modifier.fillMaxWidth().padding(20.dp), shape = RoundedCornerShape(10.dp), shadowElevation = 30.dp) {
            Column(modifier = Modifier.padding(10.dp)) {
                Text("Friend's Recent Activity", fontFamily = fredoka, fontSize = 26.sp, color = Color.White)
            }
        }
    }
